...
?>
<?php
echo '点此 <a href="off.php">注销</a>&nbsp;&nbsp;;&nbsp; 点此<a href="">查看您的操作记录</a>';
$o = 0;/*当天的课程数*/
?>
<p>今天是 第<span
    ...
    &nbsp;&nbsp;&nbsp;您今天 <span style="text-decoration-line: underline">
            ...
            if (mysqli_num_rows($result)) {
                ...
                while ($n > 0) {
                    ...
                    $m = strlen($sksjPY);
                    if (strstr($info[1], "多媒体") || strstr($info[1], "文理")) {
...
if ($o > 0) {  /*$o为当天在机房上的课程数*/
    ...
    if (strstr($todayLesson, $nowPermit)) {   /*根据时间判断当前是否有可操作的教室*/
        ...
        $i = 0;
        for ($i; $i < $o; $i++) {
            echo "<span style=\"text-decoration-line: underline\">" . $operation[$i][1] . "&nbsp;;</span>";/*输出当前可操作的机房地点*/
        }
        echo '<form action="set-network.php" method="post">
